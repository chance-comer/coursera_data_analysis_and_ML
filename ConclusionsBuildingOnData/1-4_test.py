...
import numpy as np
import pandas as pd
from scipy.stats import norm, binned_statistic_2d, chisquare, binom_test
from statsmodels.stats.proportion import proportion_confint, samplesize_confint_proportion

# H0 - уровень стресса не отличается. Средние равны.
p_75 = proportion_confint(75, 100, method = 'normal')
p_60 = proportion_confint(67, 100, method = 'normal')
...
answer1 = binom_test(67, 100, .75, alternative = 'two-sided')

z = norm.ppf(1 - 0.082222588913866079 / 2)
...
answer4 = chisquare(lf, [hist.statistic.flatten().sum() / 25] * len(lf))
